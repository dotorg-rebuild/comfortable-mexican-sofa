...
describe ComfortableMexicanSofa::Tag::PageCollapsible do
  let(:tag) { ComfortableMexicanSofa::Tag::PageCollapsible.new }
  ...
  describe '#content' do
    ...
    context 'with non-json data' do
      ...
      it 'should eq DEFAULT_FIELDS' do
        is_expected.to eq ComfortableMexicanSofa::Tag::PageCollapsible::DEFAULT_FIELDS.to_json
      end
    end
